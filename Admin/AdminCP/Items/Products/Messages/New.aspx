<%@ Page language="c#" MasterPageFile="~/AdminCP/ClearAdmin.master" CodeFile="New.aspx.cs" Inherits="AdminMessagesConsultingServices_GetAll"  %><%@ Register Assembly="MoversFW" Namespace="MoversFW" TagPrefix="cc1" %>
