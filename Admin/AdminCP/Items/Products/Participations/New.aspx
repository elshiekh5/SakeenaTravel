<%@ Page language="c#" MasterPageFile="~/AdminCP/ClearAdmin.master" CodeFile="New.aspx.cs" Inherits="AdminItemsParticipations_GetNew"  %><%@ Register Assembly="MoversFW" Namespace="MoversFW" TagPrefix="cc1" %>
