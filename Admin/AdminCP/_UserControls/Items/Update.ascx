    ...
    <tr>
                        ...
                        <table id="PhotoContainer" runat="server" class="PhotoContainer" cellspacing="0"
                            ...
                            <tr id="trImgPhoto" runat="server">
                                <td class="Image" align="center">
                                    <a runat="server" id="aPhotoPreview" href='' class="highslide" onclick="return hs.expand(this)">
                    ...
                    <td class="control">
                        <table id="Photo2Container" runat="server" class="PhotoContainer" cellspacing="0"
                            ...
                            <tr id="trImgPhoto2" runat="server">
                                <td class="Image" align="center">
                                    <a runat="server" id="aPhoto2Preview" href='' class="highslide" onclick="return hs.expand(this)">
                    ...
                    <i id="iconViewr" class="fa fa-lg"></i>
                        <script  type="text/javascript">
                            $(document).ready(function () {
                                ...
                                //});
                                //Set old icon --------------------------------------
                                var oldIcon = $("#txtIconControl").val();
                                $("#ddlFAIcons").val(oldIcon);
                                //---------------------------------------------------
      ...
      fa-youtube-square
                ...
                <tr id="trAuthorID" runat="server">
                    ...
                    <td class="Control">
                        <asp:DropDownList ID="ddlAuthorID" runat="server" CssClass="Controls">
                        </asp:DropDownList>
                    </td>
                </tr>
                ...
                <tr id="trFax" runat="server">
                    ...
                    <td class="Control">
                        ...
                        <asp:RequiredFieldValidator ValidationGroup="Items" ControlToValidate="txtFax" Display="Dynamic"
                            ID="rfvFax" runat="server" ErrorMessage="*" Text="*"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                ...
                <tr id="trEmail" runat="server">
                    ...
                    <td class="Control">
                        ...
                        <asp:RequiredFieldValidator ValidationGroup="Items" ID="rfvEmail" ControlToValidate="txtEmail"
                            runat="server" Display="Dynamic" ErrorMessage="*" Text="*"></asp:RequiredFieldValidator>
                ...
                <tr id="trToUserID" runat="server">
                    ...
                    <td class="Control">
                        <asp:DropDownList ID="ddlToUserID" runat="server" CssClass="Controls" ValidationGroup="Items" />
                    </td>
                </tr>
                
                <tr id="trIsReviewed" runat="server">
                    <td class="text">
