<%@ Page Language="C#" MasterPageFile="~/AdminCP/ClearAdmin.master" AutoEventWireup="true" CodeFile="ToOne.aspx.cs" Inherits="AdminCP_SMS_Send_ToOne"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="MainTable" cellspacing="0" cellpadding="0" width="100%" 
        ...
        <tr>
            ...
            <tr>
                <td>
                    <uc2:SendSms ID="SendSms1" runat="server" FormSmsTo="One" />
                </td>
            </tr>
    </table>
</asp:Content>
